...
export default function DealTermsForm({ evaluation }: DealTermsFormProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold">Deal Terms & Expenses</h2>
        <p className="text-sm text-muted-foreground">
          Enter pricing, income, and expense details
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="estimatedSalePrice">Est. Sale Price (ARV)</Label>
              <DollarInput
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="miscellaneous">Misc. (Monthly)</Label>
              <DollarInput
                id="miscellaneous"
                name="miscellaneous"
